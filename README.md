...
<p align="center">
  <picture>
    ...
    <img alt="Kimi Open Source Friends" width="520" src="https://kimi-file.moonshot.cn/prod-chat-kimi/kfs/4/1/2026-06-05/1d8h69fudcmosb3pipls0">
  </picture>
  <br>
...
InkOS 是一个面向故事创作的 AI Agent 系统：长篇连载、独立短篇、剧本剧作、同人番外、仿写续写和开放世界互动，都可以从同一个工作台开始。它不只是“让模型写一章”，而是把创意、设定、角色、记忆、审稿、修订、封面和互动状态放进同一条创作链路，让故事能持续生产、持续修改、持续玩下去。

## v1.5.0 - InkOS Play 发布，开放世界，用想象力游玩

v1.5.0 的重点是 InkOS Play 和 Studio 体验升级：你可以用一句自然语言创建开放世界，让角色、物品、证据、关系和时间一起推进；也可以继续写长篇、做短篇、生成封面、改设定和查状态。系统会记住世界发生了什么，并在需要时把该看的上下文带给模型，而不是把所有历史一股脑塞进提示词。
...
这版集中解决的老问题：自然语言误触发、对话“你说你的它做它的”、长篇越写越被历史拖慢、上下文超限只能硬失败、互动世界状态不可视、图片生成和文本生成错误混在一起难排查。

<p align="center">
  <img src="assets/play-openworld-warcraft.png" width="230" alt="InkOS Play 魔幻开放世界示例">
  <img src="assets/play-openworld-romance.png" width="230" alt="InkOS Play 恋爱互动示例">
  <img src="assets/play-openworld-detective.png" width="230" alt="InkOS Play 侦探互动示例">
  <img src="assets/play-item-warcraft.png" width="230" alt="InkOS Play 物品配图示例">
</p>
